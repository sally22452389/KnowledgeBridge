...
router.post("/", async (req, res) => {
  // validate the inputs before making new course
...
router.patch("/:_id", async (req, res) => {
  ...
  if (course.instructor.equals(req.user._id) || req.user.isAdmin()) {
    ...
    return res.json({
      success: false,
      message:
        "Only the instructor or this course or web admin can edit this course.",
    });
  }
});
...
router.delete("/:_id", async (req, res) => {
  ...
  if (course.instructor.equals(req.user._id) || req.user.isAdmin()) {
    ...
    return res.json({
      success: false,
      message:
        "Only the instructor or this course or web admin can delete this course.",
    });
  }
});
